      ...
      <WidthWrapper>
        <View className='pt-5'>
            ...
            <View className='bg-white h-auto p-3 rounded-lg'>
                <Text className='text-[10px] text-gray-500 font-semibold pl-3 '>{userData?.data?.bankName} Account Number</Text>
                <Text className='p-3 text-2xl text-gray-900 font-bold  '>{userData?.data?.accountNumber}</Text>
